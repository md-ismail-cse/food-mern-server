...
// ALL CUSTOMER
router.get("/", allAuth, async (req, res) => {
...
// SINGLE CUSTOMER
router.get("/:id", allAuth, async (req, res) => {
...
// UPDATE CUSTOMER
router.put("/:id", allAuth, upload.single("thumb"), async (req, res) => {
  const id = req.params.id;
...
// DELETE CUSTOMER
router.delete("/:id", allAuth, async (req, res) => {
  const id = req.params.id;
